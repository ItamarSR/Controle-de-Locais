...
<div class="container py-4">
    ...
    <div class="list-group">
        <a href="/admin/locais" class="list-group-item list-group-item-action">Gerenciar Locais</a>
        <?php if (in_array($usuario['nivel_acesso'], ['editorpro', 'admin'])): ?>
            <a href="/admin/usuarios" class="list-group-item list-group-item-action">Gerenciar Usuários</a>
        <?php endif; ?>
        <a href="/admin/import-excel" class="list-group-item list-group-item-action">Importar Excel (MPs)</a>
